  ...
  head: () => ({
    meta: [
      ...
      { title: "DeLaTrip — Tabacaria e head shop brasileira" },
      {
        name: "description",
        content:
          "Portal institucional e catálogo da DeLaTrip: sedas, dichavadores, bongs, bandejas, tabacos e conteúdo sobre o segmento.",
      },
      { name: "author", content: "DeLaTrip" },
      { property: "og:title", content: "DeLaTrip — Tabacaria e head shop brasileira" },
      {
        property: "og:description",
        content: "Catálogo curado, marcas e conteúdo da tabacaria brasileira.",
      },
